...
class _S extends State<MainPage>{
      ...
      return AlertDialog(
        ...
        content: SizedBox(width:360,height:420, child: Column(children:[
          Row(children:[
            ...
            Expanded(child: TextField(controller:yearC, keyboardType:TextInputType.number, textAlign:TextAlign.center, style:TextStyle(fontSize:20,fontWeight:FontWeight.bold), decoration:InputDecoration(labelText:'年份', border:OutlineInputBorder()), onChanged:(v){ int? yy=int.tryParse(v); if(yy!=null) setM((){ y=yy; }); })),
  ...
  Widget buildReport(){
    ...
    return Scaffold(appBar:AppBar(title:Text('${mon.year}年${mon.month}月 報表',style:TextStyle(fontSize:20,fontWeight:FontWeight.w900))), body:ListView(padding:EdgeInsets.all(16), children:[
      ...
      Card(child:ListTile(title:Text('返工 $cWork日'), subtitle:Text
