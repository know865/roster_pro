...
class Shift {
  ...
  bool isAllDay; double workHours; double otHours; bool hasAllowance; Color color;
...
class _RosterAppState extends State<RosterApp> {
  ...
  Widget buildReport(){
    ...
    return ListView(padding:const EdgeInsets.all(16), children:[
      ...
      ListTile(title:const Text("總OT"), trailing:Text("$totalOt h")),
  ...
  Widget buildSettings(){
    return ListView(padding:const EdgeInsets.all(16), children:[
      ListTile(title:const Text("Google日曆選擇"), subtitle:Text(selectedCalendarId.isEmpty?"未選擇":selectedCalendarId), onTap: () async {
        await Permission.calendarFullAccess.request();
